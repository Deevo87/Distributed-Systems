...
public interface CalcPrx extends com.zeroc.Ice.ObjectPrx
{
    ...
    default double avg(long[] arr)
        throws NoInput
    {
        return avg(arr, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default double avg(long[] arr, java.util.Map<String, String> context)
        throws NoInput
    {
        try
        {
            return _iceI_avgAsync(arr, context, true).waitForResponseOrUserEx();
        }
        catch(NoInput ex)
        {
            throw ex;
    ...
    default java.util.concurrent.CompletableFuture<java.lang.Double> avgAsync(long[] arr)
    {
        return _iceI_avgAsync(arr, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<java.lang.Double> avgAsync(long[] arr, java.util.Map<String, String> context)
    {
        return _iceI_avgAsync(arr, context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<java.lang.Double> _iceI_avgAsync(long[] iceP_arr, java.util.Map<String, String> context, boolean sync)
    {
