		...
		try {
			...
			do {
				try {
					...
					} else if (line.equals("sorting")) {
						List<Integer> arr = List.of(10, 2, 4, 78, 12, 0, 123, 11, 5);
						System.out.println("Before sorting: " + arr.toString());
						List<Integer> res = synAdvCalc1.sorting(arr);
						System.out.println("Sorting result: " + res.toString());
