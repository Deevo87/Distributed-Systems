...
public final class ExecutionServiceGrpc {
  ...
  public static final java.lang.String SERVICE_NAME = "org.Executors.ExecutionService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<org.Executors.ExecutionRequest,
      org.Executors.ExecutionResponse> getExecuteMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "execute",
      requestType = org.Executors.ExecutionRequest.class,
      responseType = org.Executors.ExecutionResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<org.Executors.ExecutionRequest,
      org.Executors.ExecutionResponse> getExecuteMethod() {
    io.grpc.MethodDescriptor<org.Executors.ExecutionRequest, org.Executors.ExecutionResponse> getExecuteMethod;
      ...
      synchronized (ExecutionServiceGrpc.class) {
        if ((getExecuteMethod = ExecutionServiceGrpc.getExecuteMethod) == null) {
          ExecutionServiceGrpc.getExecuteMethod = getExecuteMethod =
              io.grpc.MethodDescriptor.<org.Executors.ExecutionRequest, org.Executors.ExecutionResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "execute"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  org.Executors.ExecutionRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  org.Executors.ExecutionResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void execute(org.Executors.ExecutionRequest request,
        io.grpc.stub.StreamObserver<org.Executors.ExecutionResponse> responseObserver) {
  ...
  public static final class ExecutionServiceStub
    ...
    /**
     */
    public void execute(org.Executors.ExecutionRequest request,
        io.grpc.stub.StreamObserver<org.Executors.ExecutionResponse> responseObserver) {
  ...
  public static final class ExecutionServiceBlockingStub
    ...
    /**
     */
    public org.Executors.ExecutionResponse execute(org.Executors.ExecutionRequest request) {
  ...
  public static final class ExecutionServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<org.Executors.ExecutionResponse> execute(
        org.Executors.ExecutionRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_EXECUTE:
          serviceImpl.execute((org.Executors.ExecutionRequest) request,
              (io.grpc.stub.StreamObserver<org.Executors.ExecutionResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              org.Executors.ExecutionRequest,
              org.Executors.ExecutionResponse>(
  ...
  private static abstract class ExecutionServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return org.Executors.ExecutionServiceOuterClass.getDescriptor();
    }
